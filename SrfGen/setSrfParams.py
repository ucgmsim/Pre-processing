...
M_FLEN = [[10], [12, 20, 14, 7, 11]]
M_DLEN = [[0.2], [0.2] * M_NSEG[1]]
M_FWID = [[18], [18] * M_NSEG[1]]
M_DWID = [[0.2], [0.2] * M_NSEG[1]]
M_DTOP = [[1.0], [0.0] * M_NSEG[1]]
M_STK = [[40], [121, 87, 87, 216, 40]]
M_RAK = [[90], [-180, 180, 180, 78, 171]]
M_DIP = [[75], [105, 85, 85, 50, 80]]
M_ELON = [[172.135], [172.005, 172.195, 172.380, 171.9434, 172.3115]]
M_ELAT = [[-43.552], [-43.567, -43.590, -43.573, -43.5779, -43.5509]]
M_SHYPO = [[2], [6, -10, -27, 9.5, -25.5]]
