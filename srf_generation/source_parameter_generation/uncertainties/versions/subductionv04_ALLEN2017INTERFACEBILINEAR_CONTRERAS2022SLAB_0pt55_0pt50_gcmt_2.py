...
def _compute_dhypo(tectclass,mag,hypo_offset=float('0pt55'.replace('pt','.'))):
...
def _get_scaling_relation(tectclass,relations,interface='ALLEN2017INTERFACEBILINEAR',slab='CONTRERAS2022SLAB'):
