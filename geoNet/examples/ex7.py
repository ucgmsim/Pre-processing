...
tf_LF = utils.filt_stat_data(
    accMECS_LF, 1.0, "lowpass", output="sos", order=4, worN=accMECS_LF["000"].size
)
tf_HF = utils.filt_stat_data(
    accMECS_HF, 1.0, "highpass", output="sos", order=4, worN=accMECS_HF["000"].size
)
