...
stat_POTS, fig_acc_POTS, ax_acc_POTS = get_stat_acc_plot(
    loc_acc, "POTS"
)  # "WDFS", MTHS
ax_acc_POTS[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_POTS[0].set_xlim(50, 200.0)
ax_acc_POTS[1].set_xlim(50, 200.0)
ax_acc_POTS[2].set_xlim(50, 200.0)
##customize y-limits
...
stat_TEPS, fig_acc_TEPS, ax_acc_TEPS = get_stat_acc_plot(
    loc_acc, "TEPS"
)  # "WDFS", MTHS
ax_acc_TEPS[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_TEPS[0].set_xlim(50.0, 200.0)
ax_acc_TEPS[1].set_xlim(50, 200.0)
ax_acc_TEPS[2].set_xlim(50, 200.0)
##customize y-limits
...
stat_WIGC, fig_acc_WIGC, ax_acc_WIGC = get_stat_acc_plot(
    loc_acc, "WIGC"
)  # "WDFS", MTHS
ax_acc_WIGC[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_WIGC[0].set_xlim(0, 150.0)
ax_acc_WIGC[1].set_xlim(0, 150.0)
ax_acc_WIGC[2].set_xlim(0, 150.0)
# customize y-limits
...
stat_CULC, fig_acc_CULC, ax_acc_CULC = get_stat_acc_plot(
    loc_acc, "CULC"
)  # "WDFS", MTHS
ax_acc_CULC[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_CULC[0].set_xlim(0, 150.0)
ax_acc_CULC[1].set_xlim(0, 150.0)
ax_acc_CULC[2].set_xlim(0, 150.0)
# customize y-limits
...
stat_CECS, fig_acc_CECS, ax_acc_CECS = get_stat_acc_plot(
    loc_acc, "CECS"
)  # "WDFS", MTHS
ax_acc_CECS[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_CECS[0].set_xlim(0, 150.0)
ax_acc_CECS[1].set_xlim(0, 150.0)
ax_acc_CECS[2].set_xlim(0, 150.0)
# customize y-limits
...
stat_HSES, fig_acc_HSES, ax_acc_HSES = get_stat_acc_plot(
    loc_acc, "HSES"
)  # "WDFS", MTHS
ax_acc_HSES[2].set_xlabel("Time, t[s]")
# customize x-limits
ax_acc_HSES[0].set_xlim(0, 150.0)
ax_acc_HSES[1].set_xlim(0, 150.0)
ax_acc_HSES[2].set_xlim(0, 150.0)
# customize y-limits
