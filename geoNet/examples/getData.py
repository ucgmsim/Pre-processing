...
BASE_URL = (
    "ftp://ftp.geonet.org.nz/strong/processed/2013/05_May/2013-05-04_145921/Vol1/data/"
)
...
std_out, std_err = sg.get_geoNet_data(
    loc=LOC, geoNet_dir="data", geoNet_url=BASE_URL, wget_options="-N -r -nd"
)

print("Finished downloading data")
with open("std_out.txt", "w") as f:
    f.writelines(std_out.decode("utf-8"))

with open("std_err.txt", "w") as f:
    f.writelines(std_err.decode("utf-8"))
