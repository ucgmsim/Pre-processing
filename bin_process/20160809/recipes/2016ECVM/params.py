...
MODEL_LAT = '-43.65' #'-43.6000'
MODEL_LON = '172.1' #'172.3000'
MODEL_ROT = '-42.00' #'-10.0'
###
...
ts_total = '1000' # '400'   # number of slices to generate. sim time = ts_total * dt * dt_ts
...
swap_bytes = '0' #changed to one by ahsan '0'
lonlat_out = '1'
scale = '1.0'
...
FVM_ModelParams_Path='scratch/ahsan/portersPass/BB_suggested'
vel_mod_params_dir = os.path.join(global_root, FVM_ModelParams_Path)
...
stat_coords = os.path.join(vel_mod_params_dir , 'fd_nz01-h0.100.statcords')
...
FD_STATLIST = os.path.join(vel_mod_params_dir,'fd_nz01-h0.100.ll')
############### gen_ts ###################
...
plot_main_title = 'Mw7.2 Hypothetical Porters Pass Earthquake'
plot_sub_title = 'avgslip cm, maxslip cm, FVM'
...
plot_topo_file = os.path.join(plot_topo_dir, 'srtm_71_21_v2.grd')
plot_topo_illu = '-I' + os.path.join(plot_topo_dir, 'srtm_71_21_v2_i5.grd')
...
plot_topo_a_min = '2' #'0'
plot_topo_a_inc = '1' #'0.05'
plot_topo_a_max = '120' #'1.'
...
plot_x_min ='170.52'# '171.75'
plot_x_max ='173.67'# '173.00'
plot_y_min ='-44.4' #'-44.77' # '-44.00'
plot_y_max ='-42.53'#'-43.' # '-43.20'
...
plot_ts_x_min ='170.52'# '171.75'
plot_ts_x_max ='173.67'# '173.00'
plot_ts_y_min ='-44.4' #'-44.77'# '-44.00'
plot_ts_y_max ='-42.53' # '-43.20'
# region in GMT format
